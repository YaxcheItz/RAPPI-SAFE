...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-_ogb0cz@s=i8wju4+!-zn5l9yze=f_)*(y1ccou9u#-c+jh#x3')
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'rappiSafe.context_processors.operador_context',
            ],
        },
    },
]
...
AUTH_USER_MODEL = 'rappiSafe.User'
